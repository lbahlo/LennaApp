...
@Component({
   ...
   `],
    templateUrl: 'build/pages/excelis/EXECVUE/execvue.tiles.html',
    directives: [CORE_DIRECTIVES, FORM_DIRECTIVES]
})


export class EXECVUETiles implements AfterContentInit {
   ...
   // constructor() { }
    ...
    ngOnInit() {
        ...
        if (this.dataService != null) {
           this.items =  this.dataService.getExecVueItems();
        }
